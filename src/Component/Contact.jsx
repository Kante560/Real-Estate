...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "06b565f3-ba22-4992-b5de-4319746e58ae");
  ...
  return (    
    ...
    >
      ...
      <p className="text-center text-gray-500 mb-12 ">
        Ready to Make a Move? Let's Buld Your Future Together
      </p>
      ...
      <form onSubmit={onSubmit} className="max-w-2xl mx-auto text-gray-600 pt-8 col-gap-1.5">
        ...
        <div className="text-left my-6">
          message
          <textarea className="w-full border border-gray-300 rounded px-4 mt-2 h-48"name="Message" placeholder="Message" required                                                                 ></textarea>
        </div>
